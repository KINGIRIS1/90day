...
```
URL: https://ocr-memory-fix.preview.emergentagent.com//api/scan-document-public
                                                  ^^
                                                  Double slash!
```
...
```
https://ocr-memory-fix.preview.emergentagent.com
https://ocr-memory-fix.preview.emergentagent.com/
```
...
URL phải là:
```
https://ocr-memory-fix.preview.emergentagent.com/api/scan-document-public
```
...
```bash
curl -X POST https://ocr-memory-fix.preview.emergentagent.com/api/scan-document-public \
  -F "file=@test.jpg"
```
