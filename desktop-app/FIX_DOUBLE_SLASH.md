...
```
URL: https://paperscan-3.preview.emergentagent.com//api/scan-document-public
                                                  ^^
                                                  Double slash!
```
...
```
https://paperscan-3.preview.emergentagent.com
https://paperscan-3.preview.emergentagent.com/
```
...
URL phải là:
```
https://paperscan-3.preview.emergentagent.com/api/scan-document-public
```
...
```bash
curl -X POST https://paperscan-3.preview.emergentagent.com/api/scan-document-public \
  -F "file=@test.jpg"
```
