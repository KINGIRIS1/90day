...
```
URL: https://ocr-enhance.preview.emergentagent.com//api/scan-document-public
                                                  ^^
                                                  Double slash!
```
...
```
https://ocr-enhance.preview.emergentagent.com
https://ocr-enhance.preview.emergentagent.com/
```
...
URL phải là:
```
https://ocr-enhance.preview.emergentagent.com/api/scan-document-public
```
...
```bash
curl -X POST https://ocr-enhance.preview.emergentagent.com/api/scan-document-public \
  -F "file=@test.jpg"
```
