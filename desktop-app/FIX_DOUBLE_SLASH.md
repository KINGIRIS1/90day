...
```
URL: https://gcn-fix.preview.emergentagent.com//api/scan-document-public
                                                  ^^
                                                  Double slash!
```
...
```
https://gcn-fix.preview.emergentagent.com
https://gcn-fix.preview.emergentagent.com/
```
...
URL phải là:
```
https://gcn-fix.preview.emergentagent.com/api/scan-document-public
```
...
```bash
curl -X POST https://gcn-fix.preview.emergentagent.com/api/scan-document-public \
  -F "file=@test.jpg"
```
