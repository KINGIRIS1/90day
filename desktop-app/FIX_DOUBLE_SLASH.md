...
```
URL: https://vn-document-scan.preview.emergentagent.com//api/scan-document-public
                                                  ^^
                                                  Double slash!
```
...
```
https://vn-document-scan.preview.emergentagent.com
https://vn-document-scan.preview.emergentagent.com/
```
...
URL phải là:
```
https://vn-document-scan.preview.emergentagent.com/api/scan-document-public
```
...
```bash
curl -X POST https://vn-document-scan.preview.emergentagent.com/api/scan-document-public \
  -F "file=@test.jpg"
```
