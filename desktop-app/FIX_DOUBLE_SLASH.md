...
```
URL: https://landoc-scanner.preview.emergentagent.com//api/scan-document-public
                                                  ^^
                                                  Double slash!
```
...
```
https://landoc-scanner.preview.emergentagent.com
https://landoc-scanner.preview.emergentagent.com/
```
...
URL phải là:
```
https://landoc-scanner.preview.emergentagent.com/api/scan-document-public
```
...
```bash
curl -X POST https://landoc-scanner.preview.emergentagent.com/api/scan-document-public \
  -F "file=@test.jpg"
```
