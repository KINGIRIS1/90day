...
```
URL: https://dms-vietland.preview.emergentagent.com//api/scan-document-public
                                                  ^^
                                                  Double slash!
```
...
```
https://dms-vietland.preview.emergentagent.com
https://dms-vietland.preview.emergentagent.com/
```
...
URL phải là:
```
https://dms-vietland.preview.emergentagent.com/api/scan-document-public
```
...
```bash
curl -X POST https://dms-vietland.preview.emergentagent.com/api/scan-document-public \
  -F "file=@test.jpg"
```
