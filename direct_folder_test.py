...
class DirectFolderScanTester:
    def __init__(self):
        self.base_url = "https://smartdocscan-4.preview.emergentagent.com/api"
        self.auth_headers = {}
        self.test_results = []
    ...
    def test_all_zip_download(self, all_zip_url):
        ...
        # Construct full URL
        full_url = f"https://smartdocscan-4.preview.emergentagent.com{all_zip_url}"
    ...
    def test_individual_pdf_downloads(self, pdf_urls):
        ...
        for i, pdf_url in enumerate(pdf_urls):
            ...
            # Construct full URL
            full_url = f"https://smartdocscan-4.preview.emergentagent.com{pdf_url}"
