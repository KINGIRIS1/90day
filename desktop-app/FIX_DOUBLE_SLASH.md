...
```
URL: https://landoc-scanner-1.preview.emergentagent.com//api/scan-document-public
                                                  ^^
                                                  Double slash!
```
...
```
https://landoc-scanner-1.preview.emergentagent.com
https://landoc-scanner-1.preview.emergentagent.com/
```
...
URL phải là:
```
https://landoc-scanner-1.preview.emergentagent.com/api/scan-document-public
```
...
```bash
curl -X POST https://landoc-scanner-1.preview.emergentagent.com/api/scan-document-public \
  -F "file=@test.jpg"
```
