...
```
URL: https://land-doc-ocr.preview.emergentagent.com//api/scan-document-public
                                                  ^^
                                                  Double slash!
```
...
```
https://land-doc-ocr.preview.emergentagent.com
https://land-doc-ocr.preview.emergentagent.com/
```
...
URL phải là:
```
https://land-doc-ocr.preview.emergentagent.com/api/scan-document-public
```
...
```bash
curl -X POST https://land-doc-ocr.preview.emergentagent.com/api/scan-document-public \
  -F "file=@test.jpg"
```
