...
```
URL: https://vndoc-ocr.preview.emergentagent.com//api/scan-document-public
                                                  ^^
                                                  Double slash!
```
...
```
https://vndoc-ocr.preview.emergentagent.com
https://vndoc-ocr.preview.emergentagent.com/
```
...
URL phải là:
```
https://vndoc-ocr.preview.emergentagent.com/api/scan-document-public
```
...
```bash
curl -X POST https://vndoc-ocr.preview.emergentagent.com/api/scan-document-public \
  -F "file=@test.jpg"
```
