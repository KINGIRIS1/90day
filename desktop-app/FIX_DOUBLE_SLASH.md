...
```
URL: https://vietdoc-scanner.preview.emergentagent.com//api/scan-document-public
                                                  ^^
                                                  Double slash!
```
...
```
https://vietdoc-scanner.preview.emergentagent.com
https://vietdoc-scanner.preview.emergentagent.com/
```
...
URL phải là:
```
https://vietdoc-scanner.preview.emergentagent.com/api/scan-document-public
```
...
```bash
curl -X POST https://vietdoc-scanner.preview.emergentagent.com/api/scan-document-public \
  -F "file=@test.jpg"
```
