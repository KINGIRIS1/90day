...
```
URL: https://ocrviet-desktop.preview.emergentagent.com//api/scan-document-public
                                                  ^^
                                                  Double slash!
```
...
```
https://ocrviet-desktop.preview.emergentagent.com
https://ocrviet-desktop.preview.emergentagent.com/
```
...
URL phải là:
```
https://ocrviet-desktop.preview.emergentagent.com/api/scan-document-public
```
...
```bash
curl -X POST https://ocrviet-desktop.preview.emergentagent.com/api/scan-document-public \
  -F "file=@test.jpg"
```
