...
```
URL: https://docuscan-vn.preview.emergentagent.com//api/scan-document-public
                                                  ^^
                                                  Double slash!
```
...
```
https://docuscan-vn.preview.emergentagent.com
https://docuscan-vn.preview.emergentagent.com/
```
...
URL phải là:
```
https://docuscan-vn.preview.emergentagent.com/api/scan-document-public
```
...
```bash
curl -X POST https://docuscan-vn.preview.emergentagent.com/api/scan-document-public \
  -F "file=@test.jpg"
```
