...
```
URL: https://document-ai-scan.preview.emergentagent.com//api/scan-document-public
                                                  ^^
                                                  Double slash!
```
...
```
https://document-ai-scan.preview.emergentagent.com
https://document-ai-scan.preview.emergentagent.com/
```
...
URL phải là:
```
https://document-ai-scan.preview.emergentagent.com/api/scan-document-public
```
...
```bash
curl -X POST https://document-ai-scan.preview.emergentagent.com/api/scan-document-public \
  -F "file=@test.jpg"
```
