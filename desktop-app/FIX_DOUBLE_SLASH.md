...
```
URL: https://docuscan-gemini.preview.emergentagent.com//api/scan-document-public
                                                  ^^
                                                  Double slash!
```
...
```
https://docuscan-gemini.preview.emergentagent.com
https://docuscan-gemini.preview.emergentagent.com/
```
...
URL phải là:
```
https://docuscan-gemini.preview.emergentagent.com/api/scan-document-public
```
...
```bash
curl -X POST https://docuscan-gemini.preview.emergentagent.com/api/scan-document-public \
  -F "file=@test.jpg"
```
