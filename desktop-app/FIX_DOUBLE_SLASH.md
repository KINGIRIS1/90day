...
```
URL: https://landocr-pro.preview.emergentagent.com//api/scan-document-public
                                                  ^^
                                                  Double slash!
```
...
```
https://landocr-pro.preview.emergentagent.com
https://landocr-pro.preview.emergentagent.com/
```
...
URL phải là:
```
https://landocr-pro.preview.emergentagent.com/api/scan-document-public
```
...
```bash
curl -X POST https://landocr-pro.preview.emergentagent.com/api/scan-document-public \
  -F "file=@test.jpg"
```
